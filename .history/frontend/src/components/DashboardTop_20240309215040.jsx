    ...
    <div className="dashboard-top">
      ...
      <div className="content-area">
        ...
        <div className="side-nav">
          <NavLink to="/dashboard" className={({ isActive }) => isActive ? 'side-nav-spcific active' : 'side-nav-spcific'} end>Dashboardaaa</NavLink>
          ...
          <NavLink to="/dashboard/vehicles" className={({ isActive }) => isActive ? 'side-nav-spcific active' : 'side-nav-spcific'}>Vehicles</NavLink>
        </div>
        {/* 主要内容区域 */}
