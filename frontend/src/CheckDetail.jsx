import React, {
  ...
  export const DeleteCheck = ({ data, isOpen, close }) => {
  ...
  export const ManagerEditSpace = () => {
    ...
    return (
      <div className='CreatChannelOverall'>
        <DeleteCheck data={data} isOpen={isOpenDelete} close={()=>{setOpenDelete(false)}} />
        ...
        <div className='Q' ref={scrollToQ9} id='Q9'>
          ...
          <div className='Q7aDiv'>
            ...
            ></input>
              ...
              id='callupload'
              onClick={HandleT}
              src={Thumbil.includes('base64') ? Thumbil : 'data:image/jpeg;base64,' + Thumbil || '/img/addusr.png'}
        ...
        <div className='Q' id='Q10'>
          ...
          {AllImaegsString.map((item, index) => (
            ...
            >
              <HoverImage src={
                item .includes('base64') ? item : 'data:image/jpeg;base64,' + item || '/img/addusr.png'
                } alt={`Image ${index}`} />
            </div>
          ))}
        </div>
        <div className='QButton'>
          <button className='CreatButton-b' onClick={()=>EditNow(Spotid)} type='button'>
            Edit Spot
          </button>
          <button className='CreatButton-b white'>Back to Dashboard</button>
          <button className='CreatButton-b black'>Delete This Spot</button>
        </div>
      </div>
    );
  };
    ...
    return (
      <div className='CreatChannelOverall'>
        ...
        <div className='QButton'>
          ...
          <button className='CreatButton-b white'>Process later</button>
          <button className='CreatButton-b black'>Reject This Spot</button>
        </div>
      </div>
    );
  };
