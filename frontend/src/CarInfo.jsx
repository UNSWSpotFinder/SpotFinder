...
export function CarSpaceChoice() {
  ...
  const editCar = (event) => {
    ...
    if (target.id) {
      navigate('/' + username + '/editcar/' + target.id);
    }
  };
  let DelCar = () => {
    console.log('deleted');
      ...
      >
        ...
        <div className='contentmain-car'>
          ...
          <div className='Onecar'>
            ...
            <div className='carinfo-right'>
              ...
              <div className='carinfo-right-bottom'>
                <button className='carinfo-btn S' onClick={setCar}>
                  Select
                </button>
                <button className='carinfo-btn E' onClick={editCar} id='0'>
                  Edit
                </button>
                <button className='carinfo-btn D' onClick={DelCar}>
                  Delete
                </button>
              </div>
            </div>
          ...
          <div className='addcar' onClick={goesCreatCar}>
            <img src='/img/addusr.png' height={'50px'} className='addimg'></img>
